...
本站使用了Ink，因此所有Ink的CSS样式也可以被使用，完整的Ink CSS样式请参考: <http://ink.sapo.pt/ui-elements/>.

虽然Inline HTML + Ink CSS可以实现非常多样的页面，但是这样的markdown文档是不可移植的，而且markdown文档本身可读性不高，因此不推荐使用 Inline HTML 和 Ink CSS样式, 应该尽量用标准的markdown语法来写文档.
